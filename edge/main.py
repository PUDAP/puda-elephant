"""
Main entry point for the Elephant machine edge service.

This module provides the main event loop for the Elephant machine, handling command
...
async def main():
    """Initialize the Elephant machine driver and NATS client, then run the edge runner."""
    config = load_config()
